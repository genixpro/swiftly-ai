    ...
    render()
    {
        ...
        return [<td className={"rule-percentage-column"} key={1}>
            ...
            <td className={"rule-calculated-amount-column"} key={3}>
                <button type="button" className="btn btn-link p-0" id={popoverId} onClick={() => this.setState({popoverOpen: !this.state.popoverOpen})}>
            ...
            <td className={"rule-calculated-amount-column"} key={3}>
                {
                    this.props.unit.currentTenancy.rentType === 'gross' ? <span>Gross Rent</span> :
                        [
                            <button type="button" className="btn btn-link p-0" id={popoverId} onClick={() => this.setState({popoverOpen: !this.state.popoverOpen})} key={1}>
                                {
                ...
                <table className="recovery-structure-table">
                    ...
                    <tr className={"recovery-rule label-row"}>
                        ...
                        <td className={"rule-calculated-amount-column"}>
                            {
                                recovery.managementRecoveryMode !== "custom" && recovery.managementRecoveryMode !== "none" ?
                                <ManagementExpenseRecoveryCalculationPopoverWrapper appraisal={this.props.appraisal} recovery={recovery}>
