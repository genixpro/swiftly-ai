                ...
                <Col xs={12}>
                    <Card className="card-default">
                        <CardBody>
                            <div id={"view-tenants"}>
                                <Switch>
                                    <Route path={`${this.props.match.url}/appraisal_caprate`} render={(props) => <ViewAppraisalComparableSales {...capRateRouteFields} {...props} />} />
                                    <Route path={`${this.props.match.url}/appraisal_dca`} render={(props) => <ViewAppraisalComparableSales {...dcaRouteFields} {...props} />} />
                                    <Route path={`${this.props.match.url}/database`} render={(props) => <ViewComparableSalesDatabase {...routeProps} {...props} />} />
                                </Switch>
                            </div>
                        </CardBody>
                    </Card>
