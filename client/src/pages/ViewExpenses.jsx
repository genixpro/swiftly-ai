...
class ViewExpenses extends React.Component
{
    ...
    componentDidMount()
    {
        ...
        {
            this.props.navigate(`/appraisal/${this.props.appraisal._id}/expenses_tmi`);
        }
    }
    ...
    downloadWordExpenses()
    {
        ...
        window.location = reportUrl(this.props.appraisal._id, "expenses", "word");
    }

    downloadExcelExpenses()
    {
        window.location = reportUrl(this.props.appraisal._id, "expenses", "excel");
    }
