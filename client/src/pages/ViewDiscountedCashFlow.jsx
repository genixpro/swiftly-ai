...
class ViewDiscountedCashFlow extends React.Component
{
    ...
    formatCashFlowRow(cashFlowSummaryItem, rowKey, isTotal)
    {
        let className = "";
        if (isTotal)
        {
    ...
    render() {
        return [
            <AppraisalContentHeader key="header" appraisal={this.props.appraisal} title="Discounted Cash Flow" />,
                <Row key="body">
                    <Col xs={12}>
                                                        ...
                                                        <Table hover responsive>
                                                            ...
                                                            <tbody>
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.incomes.length > 0 && this.props.appraisal.discountedCashFlow.cashFlowSummary.incomes.map((item, itemIndex) => {
                                                                    return this.formatCashFlowRow(item, `income-${itemIndex}`, false);
                                                                })
                                                            }
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.years.length > 0 ?
                                                                    this.formatCashFlowRow(this.props.appraisal.discountedCashFlow.cashFlowSummary.incomeTotal, 'income-total', true)
                                                                    : null
                                                            }
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.expenses.length > 0 && this.props.appraisal.discountedCashFlow.cashFlowSummary.expenses.map((item, itemIndex) => {
                                                                    return this.formatCashFlowRow(item, `expense-${itemIndex}`, false);
                                                                })
                                                            }
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.years.length > 0 ?
                                                                    this.formatCashFlowRow(this.props.appraisal.discountedCashFlow.cashFlowSummary.expenseTotal, 'expense-total', true)
                                                                    : null
                                                            }
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.years.length > 0 ?
                                                                    this.formatCashFlowRow(this.props.appraisal.discountedCashFlow.cashFlowSummary.netOperatingIncome, 'net-operating-income', true)
                                                                    : null
                                                            }
                                                            {
                                                                this.props.appraisal.discountedCashFlow.cashFlowSummary.years.length > 0
                                                                    ? this.formatCashFlowRow(this.props.appraisal.discountedCashFlow.cashFlowSummary.presentValue, 'present-value', true)
                                                                    : null
                                                            }
                                                            </tbody>
                                                        </Table>
