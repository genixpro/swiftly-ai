...
class ViewDirectComparisonValuation extends React.Component
{
    ...
    componentDidMount()
    {
        comparableSalesApi.getMany(this.props.appraisal.comparableSalesDCA).then((comparableSales) =>
        {
    ...
    downloadWordSummary()
    {
        ...
        window.location = reportUrl(this.props.appraisal._id, "direct_comparison_valuation", "word");
    }


    downloadExcelSummary()
    {
        window.location = reportUrl(this.props.appraisal._id, "direct_comparison_valuation", "excel");
    }
    ...
    render()
    {
        ...
        return [
            <AppraisalContentHeader key="header" appraisal={this.props.appraisal} title="Direct Comparison Approach"/>,
