...
class TotalMarketRentDifferentialCalculationPopoverWrapper extends React.Component
{
    ...
    render()
    {
        return (
            [
                <button type="button" className="btn btn-link p-0" id={this.popoverId} onClick={() => this.setState({marketRentDifferentialPopoverOpen: !this.state.marketRentDifferentialPopoverOpen})}>
                    {this.props.children}
                </button>,
