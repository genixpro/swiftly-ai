...
class ExpenseRecoveryForUnitCalculationPopoverWrapper extends React.Component
{
    ...
    {
        super(props);
        this.popoverId = `expense-recovery-for-unit-${props.incomeStatementItemType}-calculation-popover-${ExpenseRecoveryForUnitCalculationPopoverWrapper.instance}`;
    ...
    render()
    {
        ...
        return (
            [<button type="button" className="btn btn-link p-0" id={this.popoverId} onClick={() => this.setState({popoverOpen: !this.state.popoverOpen})}>
                {this.props.children}
            </button>,
