...
class MarketRentDifferentialForUnitCalculationPopoverWrapper extends React.Component
{
    ...
    calculateDifferentialMonths()
    {
        ...
        for (const currentDate of eachMonthInclusive(this.props.appraisal.getEffectiveDate(), this.props.unit.currentTenancy.endDate))
        {
    ...
    render()
    {
        ...
        return (
            [
                <button type="button" className="btn btn-link p-0" id={this.popoverId}
