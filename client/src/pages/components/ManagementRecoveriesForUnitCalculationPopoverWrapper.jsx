...
class ManagementRecoveriesForUnitCalculationPopoverWrapper extends React.Component
{
    ...
    render()
    {
        ...
        return (
            [
                <button type="button" className="btn btn-link p-0" id={this.popoverId} onClick={() => this.setState({managementRecoveryPopoverOpen: !this.state.managementRecoveryPopoverOpen})} key={0}>
                    {this.props.children}
                </button>,
