                    ...
                    <Col xs={12}>
                        <Card className="card-default">
                            <CardBody>
                                <div id={"view-tenants"}>
                                    <Switch>
                                        <Route path={`${this.props.match.url}/rent_roll`} render={(props) => <ViewTenantsRentRoll {...routeProps} {...props} />} />
                                        <Route path={`${this.props.match.url}/leasing_costs`} render={(props) => <ViewTenantsLeasingCosts {...routeProps} {...props} />} />
                                        <Route path={`${this.props.match.url}/vacancy_schedule`} render={(props) => <ViewVacancySchedule {...routeProps} {...props} />} />
                                        <Route path={`${this.props.match.url}/market_rents`} render={(props) => <ViewMarketRents {...routeProps} {...props} />} />
                                        <Route path={`${this.props.match.url}/recovery_structures`} render={(props) => <ViewRecoveryStructures {...routeProps} {...props} />} />
                                    </Switch>
                                </div>
                            </CardBody>
                        </Card>
