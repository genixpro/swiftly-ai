...
class ViewCapitalizationValuation extends React.Component
{
    ...
    downloadWordSummary()
    {
        ...
        window.location = reportUrl(this.props.appraisal._id, "capitalization_valuation", "word");
    }


    downloadExcelSummary()
    {
        window.location = reportUrl(this.props.appraisal._id, "capitalization_valuation", "excel");
    }
