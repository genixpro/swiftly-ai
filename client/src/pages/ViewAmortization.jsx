...
class ViewAmortization extends React.Component
{
    ...
    {
        window.location = reportUrl(this.props.appraisal._id, "amortization_schedule", "word");
    }

    downloadExcelAmortizationSchedule()
    {
        window.location = reportUrl(this.props.appraisal._id, "amortization_schedule", "excel");
    }
